...
public record ImportContextServiceAndInstructionsResult(List<ImportSystemResult> importSystemResults, List<ImportInstructionResult> instructionResults) {

    public ImportContextServiceAndInstructionsResult {
